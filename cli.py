"""
Command Line Interface for Cyp Drug Interaction Checker.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="cyp-drug-interaction-checker", description="Cyp Drug Interaction Checker")
    ...
    if args.command == "audit":
        ...
        print("=" * 80)
        print(f"  CYP DRUG INTERACTION CHECKER")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Cyp Drug Interaction Checker Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Cyp Drug Interaction Checker API server on http://{args.host}:{args.port}")
