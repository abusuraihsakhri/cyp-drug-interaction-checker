"""
Automated Pytest for cyp-drug-interaction-checker Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    MechanismbasedVsReversibleInhibitionEngine,
    MultienzymePathwayMappingEngine,
    PharmacogenomicIntegrationEngine,
    QtProlongationRiskStackingEngine,
    FdaTableIntegrationEngine,
    ClinicalConsequenceModelingEngine,
    CypdruginteractioncheckerEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = CypdruginteractioncheckerEnrichmentSuite()
